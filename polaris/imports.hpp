...
class imports_c {
 public:
   ...
   //! happen,
   //!        if the file can't be found as-is it the include directories will
   //!        be checked iteratively. The first file found matching the name
   //!        will be imported and added to the set of imported files
